          ...
          >
            <div className="flex h-full">
              ...
              <div className="flex-1 flex flex-col bg-[rgba(20,20,20,0.3)]">
                ...
                {/* Send Files Button */}
                <div className="px-4 pb-4 border-t border-[rgba(255,255,255,0.1)] pt-3">
                  <div className="flex items-center gap-2">
                    <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-[rgba(255,255,255,0.1)] hover:bg-[rgba(255,255,255,0.15)] transition-colors">
                      <Send className="w-4 h-4 text-white" />
                      <span className="text-sm text-white font-medium">Send files</span>
                    </button>
                    <button className="w-8 h-8 rounded-lg hover:bg-[rgba(255,255,255,0.1)] flex items-center justify-center transition-colors">
