...
export const appConfig = {
  taskbarApps: [
    ...
    { name: 'Music', icon: '/cursor/music-svgrepo-com (2).svg', id: 'Music' },
    { name: 'Photos', icon: '/cursor/photos-brand-svgrepo-com.svg', id: 'Photos' },
    { name: 'Terminal', icon: '/cursor/terminal-svgrepo-com (1).svg', id: 'Terminal' },
    { name: 'About Me', icon: '/cursor/about-svgrepo-com.svg', id: 'aboutMe' },
  ],
  pinnedApps: [
    ...
    { name: 'Calendar', icon: '/cursor/about.svg', id: 'Calendar' },
  ],
  recommendedItems: [
    { name: 'Google Drive', description: 'Recently added', icon: '/cursor/drive.svg', id: 'GoogleDrive' },
    { name: 'VMware Workstation Pro', description: 'Frequently used app', icon: '/cursor/vmware.svg', id: 'VMware' },
